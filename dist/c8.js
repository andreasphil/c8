// src/c8.js
function defineAttr(definition) {
  return definition;
}
...
var C8 = class extends HTMLElement {
  /**
   ...
   * @param {string} [tag]
   */
  static define(tag2 = this.tag) {
    if (!tag2) throw new Error("Custom element must specify a tag name");
